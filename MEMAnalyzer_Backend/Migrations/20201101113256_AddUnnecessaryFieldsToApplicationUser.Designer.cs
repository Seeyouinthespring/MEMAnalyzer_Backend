...
namespace MEMAnalyzer_Backend.Migrations
{
    ...
    [Migration("20201101113256_AddUnnecessaryFieldsToApplicationUser")]
    partial class AddUnnecessaryFieldsToApplicationUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MEMAnalyzer_Backend.DBModels.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MEMAnalyzer_Backend.DBModels.Result", b =>
                {
                    ...
                    b.Property<double>("CategoryFivePercentage")
                        .HasColumnType("float");

                    b.Property<double>("CategoryFourPercentage")
                        .HasColumnType("float");

                    b.Property<double>("CategoryOnePercentage")
                        .HasColumnType("float");

                    b.Property<double>("CategorySevenPercentage")
                        .HasColumnType("float");

                    b.Property<double>("CategorySixPercentage")
                        .HasColumnType("float");

                    b.Property<double>("CategoryThreePercentage")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MEMAnalyzer_Backend.DBModels.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
